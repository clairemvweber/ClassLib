...
//        mListView = findViewById(R.id.list)
    ...
    override fun onDownloadfinished() {
        mRetainedFragment.data?.let {
            if(mRetainedFragment.data!!.isNotEmpty()) {
                ...
                intent.putExtra(LEXILE_TAG,
                    book.getJSONObject(MEASUREMENTS_TAG).getJSONObject("english")
                        .getString(LEXILE_TAG)
                )
